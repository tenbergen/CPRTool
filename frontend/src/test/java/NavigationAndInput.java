...
//            driver.switchTo().window(newwin);
////perform actions on new window
//            driver.findElement(By.xpath("//*[@id=\"identifierId\"]")).sendKeys("lmcmahan");
//            driver.manage().timeouts().implicitlyWait(5, TimeUnit.SECONDS);
//            driver.findElement(By.cssSelector("#identifierNext > div > button > span")).click();
//
//            driver.findElement(By.xpath("//*[@id=\"password\"]/div[1]/div/div[1]/input")).sendKeys("QWestWaker18!");
//            driver.findElement(By.cssSelector("#passwordNext > div > button > span")).click();
//            driver.switchTo().window(parent);
//        }
    }
    ...
    public void CreateCourseTest() {
        ...
        driver.findElement(By.cssSelector("#root > div > div.cpp-container > form > div.ccp-input-field > input[type=text]")).sendKeys("Star Gazing");
        driver.findElement(By.cssSelector("#root > div > div.cpp-container > form > div:nth-child(2) > div:nth-child(1) > input[type=text]")).sendKeys("STR 487");
        ...
        driver.findElement(By.cssSelector("#root > div > div.cpp-container > form > div:nth-child(3) > div:nth-child(1) > input[type=text]")).sendKeys("Summer");
