...
const StudentPeerReviewComponent = () => {
    ...
    return (
        <div>
            <h2> {teamName} {currentAssignment.assignment_name} Peer Review </h2>
            <div className="ap-assignmentArea">
                <div className="ap-component-links">
                    <h3> Instructions: <br/> <br/> {currentAssignment.instructions}
                        <br/> <br/> <br/>
                        Rubric: <div onClick={() => onFileClick(peerReviewFiles[0])}> {peerReviewFiles[0]} </div>
                        <br/>
                        Template: <div onClick={() => onFileClick(peerReviewFiles[1])}> {peerReviewFiles[1]} </div>
                        <br/>
                        Team Files: <div> </div>
                        <br/>
                        <form>
