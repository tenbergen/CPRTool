                        ...
                        <div className="eac-assignment-files">
                            ...
                            <p> Current files:
                                <span onClick={() => onFileClick(currentAssignment.assignment_instructions, false)}>
                                    {currentAssignmentLoaded ? currentAssignment.assignment_instructions : null}
                                </span>
                                <span onClick={() => deleteFile(currentAssignment.assignment_instructions, false)} className="crossMark">&#10060;</span>
                            </p>
                        </div>
                        ...
                        <div className="eac-assignment-files">
                            ...
                            <p> Current files:
                                <span onClick={() => onFileClick(currentAssignment.peer_review_rubric, true)}>
                                    {currentAssignmentLoaded ? currentAssignment.peer_review_rubric : null}
                                </span>
                                <span onClick={() => deleteFile(currentAssignment.peer_review_rubric, true)} className="crossMark">&#10060;</span>
                            </p>
                        </div>
                        ...
                        <div className="eac-assignment-files">
                            ...
                            <p>
                                ...
                                <span onClick={() => onFileClick(currentAssignment.peer_review_template, true)}>
                                    {currentAssignmentLoaded ? currentAssignment.peer_review_template : null}
                                </span>
                                <span onClick={() => deleteFile(currentAssignment.peer_review_template, true)} className="crossMark">&#10060;</span>
                            </p>
                        </div>
